                    ...
                    <div class="in-blog-1" data-uk-grid>
                            ...
                            <article class="uk-card uk-card-default uk-border-rounded" >
                                ...
                                <div class="uk-card-body toggle-text"  id="collection"> 
                                    ...
                                    <p class="hidden  uk-text-justify">
                                        ...
                                        (annual income, net worth, and available risk capital). Demographic information, such as gender, birth date, occupation, and employment status, is also collected when you open an account.
                                    </p>
                            ...
                            <article class="uk-card uk-card-default uk-border-rounded">
                                ...
                                <div class="uk-card-body toggle-text"  id="cookies">
                                    ...
                                    <p class="uk-text-justify">We use cookies and web beacons (also known as action tags or single-pixel gifs), and other technologies (collectively, "cookies") to provide us with data we can use 
                                        ...
                                        our site, when you return, which pages on our site you visit, and to recognize that you are already logged on when we receive a page request from your browser. We may link the information
                                         we store in cookies to personally identifiable information you submit while on our site. We will never share this information with any 3rd party. Cookies are readable only by us and do not 
                                         contain any personal information nor do they contain account or password information. We cannot and will not gather information about other sites you may have visited.
                                    </p>
                                    <p class="hidden  uk-text-justify">
                        ...
                        <div class="in-stretch">
                            <article class="uk-card uk-card-default uk-border-rounded">
                                ...
                                <div class="uk-card-body toggle-text"  id="security">
                                    <h3>
                                        <a href="#" class="link-primary text-decoration-none">The security of your personal information
                                        </a>
                                    </h3>
